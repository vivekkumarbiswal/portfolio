...
## Corpus Check
- 24 files · ~11,291 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 62 nodes · 41 edges · 22 communities detected
...
1. `Graph Report` - 5 edges
2. `PortfolioDataService` - 4 edges
3. `ShellComponent` - 4 edges
4. `ResumeComponent` - 4 edges
5. `HeroComponent` - 4 edges
6. `SkillsComponent` - 3 edges
7. `Main Bootstrap Application` - 2 edges
8. `ContactComponent` - 2 edges
9. `MarqueeComponent` - 2 edges
10. `TimelineComponent` - 2 edges
...
- `Scalability Note` --references--> `Graph Report`  [EXTRACTED]
  README.md → graphify-out/GRAPH_REPORT.md
- `Projects Component` --semantically_similar_to--> `Projects Preview Component`  [INFERRED] [semantically similar]
  src/app/features/projects/projects.component.ts → src/app/features/projects-preview/projects-preview.component.ts
...
Cohesion: 1.0
Nodes (2): Projects Component, Projects Preview Component

### Community 13 - "Community 13"
Cohesion: 1.0
Nodes (2): Production Environment Config, Environment Config
...
## Knowledge Gaps
- **19 isolated node(s):** `App Root Router Outlet`, `App Providers Config`, `Theme Service`, `Footer Component`, `Header Component` (+14 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 10`** (2 nodes): `HomeComponent`, `home.component.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 11`** (2 nodes): `NotFoundComponent`, `not-found.component.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 12`** (2 nodes): `Projects Component`, `Projects Preview Component`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 13`** (2 nodes): `Production Environment Config`, `Environment Config`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 14`** (1 nodes): `app.routes.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 15`** (1 nodes): `portfolio.models.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 16`** (1 nodes): `Theme Service`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (1 nodes): `Footer Component`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (1 nodes): `Header Component`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (1 nodes): `Reveal Directive`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (1 nodes): `Resume Placeholder PDF`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (1 nodes): `Project Placeholder SVG`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
